...
export declare class AppMenuItemView extends AppMenuItemView_base {
    #private;
    static getAllPanels(driver: GmailDriver): HTMLElement[];
    static getActivePanel(driver: GmailDriver, useSdkActiveSelector?: boolean): HTMLElement | null | undefined;
    static deactivatePanel(panel: HTMLElement): void;
    static isMenuItem(element: HTMLElement): boolean;
    static getAllMenuItems(driver: GmailDriver): HTMLElement[];
    static getActiveMenuItem(driver: GmailDriver): HTMLElement | null | undefined;
